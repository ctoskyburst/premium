...
const colors = {
  ...
  gold: "#FCCF31",
  darkGold: "#4E3D00",
  darkLinearGradient: `rgba(210, 164, 0, 0.82) 24.09%, rgba(138, 109, 6, 0.82) 114.09%`,
  lightLinearGradient: `#FCCF31 41.85%, rgba(138, 109, 6, 0.72) 93.39%`
};
const spacing = {
  xm: "4px",
  sm: "8px",
...
default_1((page) => createInertiaApp({
  ...
  resolve: (name) => resolvePageComponent(`./Pages/${name}.jsx`, /* @__PURE__ */ Object.assign({ "./Pages/About.jsx": () => import("./assets/About.9faf4424.mjs"), "./Pages/Contact.jsx": () => import("./assets/Contact.5d9e542c.mjs"), "./Pages/OurProgress.jsx": () => import("./assets/OurProgress.ddc7aa65.mjs"), "./Pages/ServicePage.jsx": () => import("./assets/ServicePage.c45ac3c1.mjs"), "./Pages/Thanks.jsx": () => import("./assets/Thanks.7ac6770a.mjs"), "./Pages/Welcome.jsx": () => import("./assets/Welcome.9ad9449d.mjs") })),
  setup: ({
    App,
    props
  }) => {
    ...
    return /* @__PURE__ */ jsxs(Fragment, {
      children: [/* @__PURE__ */ jsx(GlobalStyle, {}), /* @__PURE__ */ jsx(App, {
        ...props
      })]
    });
  }
